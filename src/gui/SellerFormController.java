...
public class SellerFormController implements Initializable {
	...
	private DepartmentService departementServices;
	...
	private Seller getFormData() {
		...
		obj.setId(Utils.trypasrseToInt(txtId.getText()));
		...
		obj.setBaseSalary(Utils.trypasrseToDouble(txtBaseSalary.getText()));
